    ...
    <div class="lg:col-span-3 mb-4">
      <div class="bg-white rounded-lg shadow p-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div
            class="md:col-span-2 flex flex-col md:flex-row md:items-end gap-2 mt-4 md:mt-0"
          >
            <div class="flex-1">
              <label class="block text-sm font-medium text-gray-700 mb-1"
                >Tìm kiếm</label
              ...
              <div class="flex gap-2">
                <select
                  ...
                  class="w-32 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                >
                ...
                <button
                  type="button"
                  @click="
                    activeTab === 'staff' ? onSearchStaff() : onSearchGolfer()
                  "
...
const selectedGolferId = ref(null);
