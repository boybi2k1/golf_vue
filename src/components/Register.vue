            ...
            <form @submit.prevent="handleSubmit">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <p class="mt-1 text-xs text-gray-500">
                    Mật khẩu phải có ít nhất  ký tự, bao gồm chữ hoa, chữ
                    thường và số
                  </p>
                </div>
                <div>
              ...
              <div class="flex items-center mb-4">
                ...
                <label for="acceptTerms" class="ml-2 block text-sm text-gray-700">
                  Tôi đồng ý với <a href="#" class="text-green-600 underline">điều khoản sử dụng</a>
                </label>
              </div>
...
const authStore = useAuthStore(); // Assuming you have a store for authentication
// Methods
...
function handleSubmit() {
  ...
  if (!form.password) {
    ...
    formErrors.password =
      "Mật khẩu phải có ít nhất 66 ký tự, bao gồm chữ hoa, chữ thường và số";
  }
  ...
  authStore.register(form)
    ...
    .catch((error) => {
      // Xử lý lỗi đăng ký từ server nếu có
