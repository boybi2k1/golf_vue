          ...
          <div class="mb-4">
            ...
            >
              ...
              >
                ...
                <p class="text-sm text-gray-600 mb-2">Chọn ảnh sự kiện</p>
        ...
        <div class="px-6 py-4">
          <div class="flex flex-col md:flex-row items-center mb-4 gap-4">
            <div class="w-full md:w-1/3 flex-shrink-0">
              ...
              <div
                v-else
                class="w-full h-32 flex items-center justify-center bg-gray-100 text-gray-400 border border-green-100 rounded-lg"
              >
                Không có ảnh
              </div>
            </div>
...
function onEventImageChange(e) {
  ...
  if (!selected) return;
  eventFile.value = selected;
  const reader = new FileReader();
  reader.onload = (evt) => {
    eventForm.imageUrl = evt.target.result;
  };
...
function viewEventDetails(event) {
  ...
  console.log("Selected event for details:", selectedEvent.value);
...
function editEvent(event) {
  ...
  eventForm.imageUrl = URL_IMAGE + event.imageUrl;
  showEventModal.value = true;
}
...
async function saveEvent() {
  ...
  formData.append("discountPercent", eventForm.discountPercent);
  formData.append("startDate", eventForm.startDate);
  formData.append("endDate", eventForm.endDate);
  formData.append("targetUserType", eventForm.targetUserType);
