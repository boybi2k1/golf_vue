...
function saveService() {
  ...
  // Nếu có file ảnh thì dùng FormData, nếu không thì gửi object thường
  ...
  if (!isEditMode.value) {
    ...
    console.log("Updating service with ID:", selectedServiceId.value);
    servicesStore.updateService(selectedServiceId.value, payload);
  }
  closeServiceModal();
}
          ...
          <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
            ...
            <div>
              ...
              >
                ...
                <option value="TOOL">Dụng cụ khác</option>
          ...
          <div class="px-6 py-4">
            <div class="flex flex-col md:flex-row items-center mb-4 gap-4">
              <div class="w-full md:w-1/3 flex-shrink-0">
                ...
                <div
                  v-else
                  class="w-full h-28 flex items-center justify-center bg-gray-100 text-gray-400 border border-green-100 rounded-lg"
                >
                  Không có ảnh
                </div>
              </div>
